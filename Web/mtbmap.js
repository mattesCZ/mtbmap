...
// overlays
        overlayMtbscale = new OpenLayers.Layer.OSM("MTB Symbol", "overlay-mtbscale_tiles/", {type: 'png', numZoomLevels: 19, getURL: getTileURL});
        overlayMtbscale.setIsBaseLayer(false);
        overlayMtbscale.setVisibility(false);
        map.addLayer(overlayMtbscale);
